...
//             <HashLoader size={30} color="#1ab188" />
//           </div>
//         ) : (
    ...
    >
      ...
      <div className={styles.contactForm}>
        <form className={styles.form} ref={form} onSubmit={sendEmail}>
          <h3>
            Let's talk about something <span>great </span> together
          </h3>
        ...
        <div className={styles.contactContainer}>
          <div className={styles.contactInfoCard}>
            ...
            <div className={styles.iconContainer}>
              <span className={styles.iconContainerSpan}>
                <MdEmail /> gauravsingh180477@gmail.com
              </span>
              <span className={styles.iconContainerSpan}>
                <FcCellPhone /> +91 6397846708
              </span>
              <span className={styles.iconContainerSpan}>
                <FaLocationDot /> Dehradun, Uttarakhand
              </span>
              <span className={styles.iconContainerSpan}>
                <FcAlarmClock /> Response time: Within 24 hours
              </span>
            </div>
          </div>

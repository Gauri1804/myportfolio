...
const skillData = [
    ...
    //Frontend Data
    {
        category: "Frontend",
        items: [
            { name: "HTML5", icon: <FaHtml5 className='icon' color="#E34F26" size={24} /> },
            { name: "CSS3", icon: <FaCss3Alt className='icon' color="#1572B6" size={24} /> },
            { name: "JavaScript", icon: <FaJs className='icon' color="#F7DF1E" size={24} /> },
            { name: "React", icon: <FaReact className='icon' color="#61DAFB" size={24} /> },
            { name: "Sass", icon: <FaSass className='icon' color="#CC6699" size={24} /> },
            { name: "Tailwind CSS", icon: <RiTailwindCssFill className='icon' color="#38B2AC" size={24} /> },
        ]
    },
    ...
    //Backend Data
    {
        ...
        items: [
            ...
            { name: "Express", icon: <SiExpress color="purple" size={24} /> },
                        ...
                        <ul className={styles.cardList}>
                            {section.items.map((item, idx) => (
                                <li className={styles.cardListItems} key={idx}>
                                    <span className={styles.icon} >{item.icon} </span>    <span>{item.name}</span>
                                </li>
                            ))
                            }
                        </ul>
